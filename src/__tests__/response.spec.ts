...
describe('HttpResponse', () => {
  describe('constructor()', () => {
    ...
    it('accepts a falsy body', () => {
      const httpResponse1 = new HttpResponse({ body: false });
      expect(httpResponse1.body).toEqual(false);
      const httpResponse2 = new HttpResponse({ body: 0 });
      expect(httpResponse2.body).toEqual(0);
    });
  });
