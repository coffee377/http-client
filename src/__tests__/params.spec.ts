...
describe('HttpUrlEncodedParams', () => {
  describe('initialization', () => {
    ...
    test('should ignore question mark in a url', () => {
      const params = new HttpParams('?a=b&c=d&c=e');
      expect(params.getAll('a')).toEqual(['b']);
      expect(params.getAll('c')).toEqual(['d', 'e']);
    });

    test('should only remove question mark at the beginning of the params', () => {
  ...
  describe('lazy mutation', () => {
    ...
    test('should allow appending all number parameters', () => {
    ...
    test('should allow appending all boolean parameters', () => {
    ...
    test('should allow appending all parameters of different types', () => {
      const params = new HttpParams('a=true&b=b1');
    ...
    test('should allow deletion of parameters with specific string value', () => {
      const params = new HttpParams('a=b&c=d&e=f');
    ...
    test('should allow deletion of parameters with specific number value', () => {
    ...
    test('should allow deletion of parameters with specific boolean value', () => {
    ...
    test('should allow deletion of one value of a string parameter', () => {
    ...
    test('should allow deletion of value of a number parameter', () => {
    ...
    test('should allow deletion of value of a boolean parameter', () => {
  ...
  describe('toString', () => {
    ...
    test('should stringify boolean array params', () => {
    ...
    test('should stringify array params of different types', () => {
